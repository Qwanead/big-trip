...
const API = class {
  ...
  getPoints(allOffers, destinations) {
    return this._load({url: `points`})
      ...
      .then((response) => _models_point_model__WEBPACK_IMPORTED_MODULE_0__["default"].parsePoints({response, allOffers, destinations}));
  }
...
/* harmony import */ var flatpickr_dist_themes_light_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flatpickr_dist_themes_light_css__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _controllers_point_controller__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../controllers/point-controller */ "./src/controllers/point-controller.js");
...
const getEventTypeTemplate = (eventType) => {
  return (
    `<div class="event__type-item">
      ...
      <label class="event__type-label  event__type-label--${eventType}" for="event-type-${eventType}-1">${Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["formatCase"])(eventType)}</label>
    </div>`
  );
};
...
const getEventTypeList = Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["generateTemplates"])(getEventTypeTemplate);
const getOptionsList = Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["generateTemplates"])(getOptionTemplate);
const getOffersList = Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["generateTemplates"])(getOfferTemplate);
const getPicturesList = Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["generateTemplates"])(getPictureTemplate);
      ...
      <header class="event__header">
        <div class="event__type-wrapper">
          ...
          <div class="event__type-list">
            <fieldset class="event__type-group">
              ...
              ${getEventTypeList(_const__WEBPACK_IMPORTED_MODULE_2__["POINT_TYPES"])}
            </fieldset>

            <fieldset class="event__type-group">
              <legend class="visually-hidden">Activity</legend>

              ${getEventTypeList(_const__WEBPACK_IMPORTED_MODULE_2__["POINT_ACTIVITYS"])}
            </fieldset>
          </div>
        </div>
        ...
        <div class="event__field-group  event__field-group--destination">
          <label class="event__label  event__type-output" for="event-destination-1">
            ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["formatCase"])(type)} ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["isActivitys"])(type) ? `in` : `to`}
          </label>
        ...
        <button class="event__reset-btn" type="reset">${mode === _controllers_point_controller__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING ? `Cancel` : `Delete`}</button>
        ${mode === _controllers_point_controller__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING ? `` : `
...
class EventEdit extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_4__["default"] {
  constructor(point, mode = _controllers_point_controller__WEBPACK_IMPORTED_MODULE_5__["Mode"].DEFAULT) {
    super();
    this._mode = mode;
    this._point = point;
  ...
  setOnFavoriteButtonClick(onClick) {
    if (this._mode === _controllers_point_controller__WEBPACK_IMPORTED_MODULE_5__["Mode"].ADDING) {
      return;
    }
  ...
  _applyFlatpickr() {
    ...
    this._flatpickrDateFrom = flatpickr__WEBPACK_IMPORTED_MODULE_6___default()(dateFromElement, {
      enableTime: true,
      altInput: true,
      allowInput: true,
    ...
    this._flatpickrDateTo = flatpickr__WEBPACK_IMPORTED_MODULE_6___default()(dateToElement, {
      enableTime: true,
      altInput: true,
      allowInput: true,
      dateFormat: `M-d-Y H:i`,
  ...
  return (
    `<li class="trip-days__item  day">
      <div class="day__info">
        ...
        <time class="day__date" datetime="${day}">${moment__WEBPACK_IMPORTED_MODULE_2___default()(day, `YYYY-MM-DD`).format(`MMM DD`).toUpperCase()}</time>
      </div>
...
const getDaysDiff = (day, previousDay) =>
  moment__WEBPACK_IMPORTED_MODULE_2___default()(day, `YYYY-MM-DD`).diff(moment__WEBPACK_IMPORTED_MODULE_2___default()(previousDay, `YYYY-MM-DD`), `day`);

const getDaysListTemplate = (points) => {
  const DaySet = new Set();

  points.forEach((point) =>
    DaySet.add(moment__WEBPACK_IMPORTED_MODULE_2___default()(point.dateFrom).format(`YYYY-MM-DD`))
  );
  ...
  const getDaysTemplates = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["generateTemplates"])(getDayTemplate);
...
class EventList extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(points) {
    super();
    this._points = points;
...
const convertDateToTime = (date) => moment__WEBPACK_IMPORTED_MODULE_2___default()(date).format(`HH:mm`);

const calculateDiffDate = (beginDate, endDate) => {

  const minutesDiff = moment__WEBPACK_IMPORTED_MODULE_2___default()(endDate).diff(moment__WEBPACK_IMPORTED_MODULE_2___default()(beginDate), `minutes`);
  const hoursDiff = moment__WEBPACK_IMPORTED_MODULE_2___default()(endDate).diff(moment__WEBPACK_IMPORTED_MODULE_2___default()(beginDate), `hours`);
  const daysDiff = moment__WEBPACK_IMPORTED_MODULE_2___default()(endDate).diff(moment__WEBPACK_IMPORTED_MODULE_2___default()(beginDate), `days`);
  ...
  if (minutesDiff < MINUTES_IN_HOUR) {
    return `${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatNumber"])(minute)}M`;
  }

  if (hoursDiff < HOURS_IN_DAY) {
    return `${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatNumber"])(hour)}H ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatNumber"])(minute)}M`;
  }

  return `${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatNumber"])(day)}D ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatNumber"])(hour)}H ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatNumber"])(minute)}M`;
};
...
const getOffersListTemplate = (offersChecked) => {
  ...
  const getOffersTemplates = Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["generateTemplates"])(getOfferTemplate);
  ...
  return (
    `<li class="trip-events__item">
      <div class="event">
        ...
        <h3 class="event__title">${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatCase"])(type)} ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["isActivitys"])(type) ? `in` : `to`} ${destination}</h3>
...
class Event extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(point) {
    super();
    this._point = point;
...
class Events extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
  ...
  return (
    `<div class="trip-filters__filter">
      <input
        ...
        ${isChecked ? `checked` : ``}
      >
      <label class="trip-filters__filter-label" for="filter-${title}">${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatCase"])(title)}</label>
    </div>`
  );
};

const getFilterTemplates = Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["generateTemplates"])(getFilterTemplate);
...
const getMenuList = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["generateTemplates"])(getMenuItemTemplate);
...
/* harmony default export */ __webpack_exports__["default"] = (NewEventButton);
...
class Sort extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  setOnSortTypeChange(onChange) {
    this._onSortTypeChange = onChange;

    this.getElement().addEventListener(`change`, (evt) => {
      this._currentSortType = evt.target.value;
      onChange(this._currentSortType);
    });
  }
}
...
const getTotalCostOfType = (points, type) => {
  ...
  return Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["calculateTotalCost"])(pointsOfSelectedType);
};
...
const renderTimeChart = (timeCtx, points) => {
  ...
  const labels = points.map((pointItem) => {
    ...
    return `${EmojiMap[pointItem.type]} ${pointItem.type.toUpperCase()} ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["isActivitys"])(pointItem.type) ? `IN ` : `TO `}${pointItem.destination.toUpperCase()}`;
  });

  return new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(timeCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_3___default.a],
    type: `horizontalBar`,
    data: {
      labels,
...
class Statistics extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
...
const createTripCostTemplate = (points) => {
  const tripCost = Object(_utils_common__WEBPACK_IMPORTED_MODULE_1__["calculateTotalCost"])(points);
...
class TripCost extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(points) {
    super();
    this._points = points;
  }
...
/* harmony default export */ __webpack_exports__["default"] = (TripCost);
...
const getTripDate = (points) => {
  ...
  const convertDate = (date) => {
    const month = moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`MMM`).toUpperCase();
    const day = moment__WEBPACK_IMPORTED_MODULE_1___default()(date).format(`DD`);
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: POINT_TYPES, POINT_ACTIVITYS, FilterType, SortType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "POINT_TYPES", function() { return POINT_TYPES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "POINT_ACTIVITYS", function() { return POINT_ACTIVITYS; });
...
class FilerController {
  ...
  render() {
    ...
    this._filtersComponent = new _components_filter__WEBPACK_IMPORTED_MODULE_2__["default"](filters);

    this._filtersComponent.setOnFilterTypeChange(this._onFilterChange);

    if (oldComponent) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._filtersComponent, oldComponent);
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._filtersComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    }
  }
...
/* harmony default export */ __webpack_exports__["default"] = (FilerController);
...
/*!*********************************************!*\
  !*** ./src/controllers/point-controller.js ***!
  \*********************************************/
/*! exports provided: default, Mode, EmptyPoint */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_event_edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/event-edit */ "./src/components/event-edit.js");
...
const parseFormData = (formData, form, point, typePoint) => {
  ...
  const formatDate = (date) => moment__WEBPACK_IMPORTED_MODULE_4___default()(date, `MMM-DD-YYYY HH:mm`).format();
...
class PointController {
  ...
  render(point, mode = Mode.DEFAULT) {
    ...
    if (this._containerElement && mode === Mode.DEFAULT) {
      const dayContainerElement = this._containerElement.querySelector(`.trip-events__list[date-time="${moment__WEBPACK_IMPORTED_MODULE_4___default()(point.dateFrom).format(`YYYY-MM-DD`)}"]`);
    ...
    this._eventComponent = new _components_event__WEBPACK_IMPORTED_MODULE_1__["default"](point);
    this._eventEditComponent = new _components_event_edit__WEBPACK_IMPORTED_MODULE_2__["default"](point, mode);
    ...
    if ((oldEventComponent === null) || (oldEventEditComponent === null)) {
      if (mode === Mode.ADDING) {
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._containerElement, this._eventEditComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
        this._hideEventDetails();
        document.addEventListener(`keydown`, this._onDocumentKeyDown);
      } else {
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(this._containerElement, this._eventComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
      }
    } else {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._eventComponent, oldEventComponent);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._eventEditComponent, oldEventEditComponent);
    }
  }
  ...
  _replaceEventToEdit() {
    this._onViewChange();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._eventEditComponent, this._eventComponent);
    this._mode = Mode.EDIT;
  }

  _replaceEditToEvent() {
    this._eventEditComponent.reset();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["replace"])(this._eventComponent, this._eventEditComponent);
  ...
  destroy() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._eventEditComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["remove"])(this._eventComponent);
    document.removeEventListener(`keydown`, this._onDocumentKeyDown);
  }
...
/* harmony import */ var _point_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./point-controller */ "./src/controllers/point-controller.js");
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _components_event_list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/event-list */ "./src/components/event-list.js");
/* harmony import */ var _components_no_points__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/no-points */ "./src/components/no-points.js");
...
const renderEvents = (eventsListElement, points, onDataChange, onViewChange, destinations, allOffers) => {
  return points.map((point) => {
    const pointController = new _point_controller__WEBPACK_IMPORTED_MODULE_1__["default"](eventsListElement, onDataChange, onViewChange, destinations, allOffers);
...
class TripController {
  constructor(container, pointsModel, tripInfoComponent, tripCostComponent, newEventButtonComponent, filterController, api) {
    ...
    this._destinations = [];
    this._allOffers = [];
    this._sortType = _const__WEBPACK_IMPORTED_MODULE_0__["SortType"].DEFAULT;

    this._noPointsComponent = new _components_no_points__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._sortComponent = new _components_sort__WEBPACK_IMPORTED_MODULE_5__["default"]();
    ...
    this._setOnNewEventButtonClick(() => {
      ...
      this._pointsModel.setFilter(_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].EVERYTHING);
      this._onViewChange();
      this._createPoint();
  ...
  render() {
    ...
    this._eventListComponent = new _components_event_list__WEBPACK_IMPORTED_MODULE_3__["default"](points);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._noPointsComponent);


    if (points.length === 0) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(containerElement, this._noPointsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
      return;
    }

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(containerElement, this._sortComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(containerElement, this._eventListComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
  ...
  _createPoint() {
    ...
    if (this._pointsModel.getAllPoints().length === 0) {
      const containerElement = this._container.getElement();
      this._eventListComponent = new _components_event_list__WEBPACK_IMPORTED_MODULE_3__["default"]([]);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(containerElement, this._sortComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(containerElement, this._eventListComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._noPointsComponent);
    }

    this._creatingPoint = new _point_controller__WEBPACK_IMPORTED_MODULE_1__["default"](this._eventListComponent.getElement(), this._onDataChange, this._onViewChange, this._destinations, this._allOffers);
    this._creatingPoint.render(Object.assign({}, _point_controller__WEBPACK_IMPORTED_MODULE_1__["EmptyPoint"], this._pointsModel.getAdditionalInfo()), _point_controller__WEBPACK_IMPORTED_MODULE_1__["Mode"].ADDING);
  }
  ...
  _onSortingFormChange(sortType) {
    ...
    switch (sortType) {
      case _const__WEBPACK_IMPORTED_MODULE_0__["SortType"].PRICE:
        sortedPoints = points.slice().sort((a, b) => b.basePrice - a.basePrice);
        break;
      case _const__WEBPACK_IMPORTED_MODULE_0__["SortType"].TIME:
        sortedPoints = points.slice().sort((a, b) => a.duration - b.duration);
        break;
      case _const__WEBPACK_IMPORTED_MODULE_0__["SortType"].DEFAULT:
        sortedPoints = points;
        break;
    }

    if (sortType === _const__WEBPACK_IMPORTED_MODULE_0__["SortType"].DEFAULT) {
  ...
  _onDataChange(pointController, oldData, newData, mode = _point_controller__WEBPACK_IMPORTED_MODULE_1__["Mode"].DEFAULT, onError) {
    this._newEventButtonComponent.setEnabled();
    // новая точка
    if (oldData === null) {
      this._newEventButtonComponent.setEnabled();
    ...
    // удаление старой
      ...
      // редактирование старой
        ...
        .then((pointModel) => {
          ...
          if (isSuccess) {
            if (mode === _point_controller__WEBPACK_IMPORTED_MODULE_1__["Mode"].DEFAULT) {
              this._updatePoints();
  ...
  _updatePoints() {
    this._removePoints();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._eventListComponent);
    this.render();
  }
...
/* harmony import */ var _controllers_filters_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./controllers/filters-controller */ "./src/controllers/filters-controller.js");
...
/* harmony import */ var _components_new_event_button__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/new-event-button */ "./src/components/new-event-button.js");
...
/* harmony import */ var _components_trip_cost__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/trip-cost */ "./src/components/trip-cost.js");
/* harmony import */ var _components_trip_info__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/trip-info */ "./src/components/trip-info.js");
...
const api = new _api_js__WEBPACK_IMPORTED_MODULE_1__["default"](END_POINT, AUTHORIZATION);
const menuComponent = new _components_menu__WEBPACK_IMPORTED_MODULE_4__["default"]();
const eventsComponent = new _components_events__WEBPACK_IMPORTED_MODULE_2__["default"]();
const newEventButtonComponent = new _components_new_event_button__WEBPACK_IMPORTED_MODULE_5__["default"]();
const pointsModel = new _models_points_model__WEBPACK_IMPORTED_MODULE_6__["default"]();
const filterController = new _controllers_filters_controller__WEBPACK_IMPORTED_MODULE_3__["default"](tripControlsElement, pointsModel);
let allOffers = [];
let destinations = [];

Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(menuHeaderElement, menuComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTER);
Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(tripControlsElement, newEventButtonComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTER);
...
api.getOffers()
  ...
  .then(() => {
    ...
    .then((points) => {
      ...
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(eventsContainerElement, eventsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);

      pointsModel.setPoints(points);

      const tripInfoComponent = new _components_trip_info__WEBPACK_IMPORTED_MODULE_10__["default"](pointsModel.getAllPoints());
      const tripCostComponent = new _components_trip_cost__WEBPACK_IMPORTED_MODULE_9__["default"](pointsModel.getAllPoints());
      const tripController = new _controllers_trip_controller__WEBPACK_IMPORTED_MODULE_8__["default"](eventsComponent, pointsModel, tripInfoComponent, tripCostComponent, newEventButtonComponent, filterController, api);
      tripController.setAllOffers(allOffers);
      tripController.setDetinations(destinations);

      filterController.render();
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(tripInfoElement, tripInfoComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(tripInfoElement, tripCostComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
      tripController.render();

      const statisticsComponent = new _components_statistics__WEBPACK_IMPORTED_MODULE_7__["default"](pointsModel);
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(eventsContainerElement, statisticsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
...
class Points {
  constructor() {
    ...
    this._activeFilter = _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].EVERYTHING;
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: isActivitys, formatCase, formatNumber, calculateTotalCost, generateTemplates, formatString */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isActivitys", function() { return isActivitys; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatCase", function() { return formatCase; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatNumber", function() { return formatNumber; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "calculateTotalCost", function() { return calculateTotalCost; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateTemplates", function() { return generateTemplates; });
...
const isActivitys = (eventType) => _const__WEBPACK_IMPORTED_MODULE_0__["POINT_ACTIVITYS"].some((activity) => activity === eventType);
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: createElement, render, RenderPosition, remove, replace */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
